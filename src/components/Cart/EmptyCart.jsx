...
const EmptyCart = () => {
  return (
    <div class="empty-cart flex flex-col items-center justify-center w-full ">
      <svg
        viewBox="656 573 264 182"
        version="1.1"
        xmlns="http://www.w3.org/2000/svg"
        className="w-5/6 my-10 lg:h-40"
      >
        <rect
          id="bg-line"
          stroke="none"
      ...
      <h3 className="font-black text-2xl ">Cart is empty</h3>
      <Link
        to="/app/products"
        className="text-indigo-600 font-bold flex items-center my-3"
      >
        <svg
